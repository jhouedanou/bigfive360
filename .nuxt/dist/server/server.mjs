...
import { ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderComponent, ssrRenderTeleport, ssrIncludeBooleanAttr, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const useGlobalData = () => {
  return useAsyncData("globalData", () => import("./_nuxt/data-BZocFfmE.js").then((m) => m.default));
};
const _sfc_main$2 = {
  __name: "app",
  __ssrInlineRender: true,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Bn_eF_G9.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BLDB5dSg.js").then((r) => r.default || r));
