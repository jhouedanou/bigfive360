...
import { getContext } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, appendHeader, createError as createError$1 } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/h3/dist/index.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery, encodeParam, withLeadingSlash, parseURL, isEqual, encodePath, stringifyParsedURL, stringifyQuery, parseQuery } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/ufo/dist/index.mjs';
import { CapoPlugin, getActiveHead } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/@unhead/shared/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/defu/dist/defu.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderComponent, ssrRenderTeleport, ssrRenderList, ssrIncludeBooleanAttr, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/vue/server-renderer/index.mjs';
import { useVuelidate } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/@vuelidate/core/dist/index.mjs';
import { required, email } from 'file:///Users/bigfiveproduction/bigfive360/node_modules/@vuelidate/validators/dist/index.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/devalue/index.js';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/@unhead/ssr/dist/index.mjs';
import '../runtime.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/destr/dist/index.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/unenv/runtime/fetch/index.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/klona/dist/index.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/scule/dist/index.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/ohash/dist/index.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/unstorage/dist/index.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/unstorage/drivers/fs.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/unstorage/drivers/fs-lite.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/unstorage/drivers/lru-cache.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/unenv/runtime/npm/consola.mjs';
import 'node:fs';
import 'node:url';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/pathe/dist/index.mjs';
import 'file:///Users/bigfiveproduction/bigfive360/node_modules/ipx/dist/index.mjs';
...
const robot_meta_server_6Qhe4cPOr2 = /* @__PURE__ */ defineNuxtPlugin({
  setup() {
    ...
    const ctx = (_a = event2 == null ? void 0 : event2.context) == null ? void 0 : _a.robots;
    if (!ctx)
      return;
    useServerHead({
      meta: [
...
const swiper_xwaaUO4rVf = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.component("Swiper", Swiper2);
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file:///Users/bigfiveproduction/bigfive360/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const ipxStaticRuntime$D8T3He9rYt = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipxStatic"]: { provider: ipxStaticRuntime$D8T3He9rYt, defaults: {} }
};
const useImage = () => {
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d5ff42a6><div class="container" data-v-d5ff42a6><h2 class="section-title" data-v-d5ff42a6>${ssrInterpolate((_a = unref(globalData)) == null ? void 0 : _a.ccm.titre)}</h2><div class="columns" data-v-d5ff42a6><!--[-->`);
      ssrRenderList((_b = unref(globalData)) == null ? void 0 : _b.ccm.etapes, (etape, index) => {
        _push(`<div class="column is-4" data-v-d5ff42a6>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        _push(`<h4 data-v-d5ff42a6>${ssrInterpolate(etape.titre)}</h4>`);
        if (etape.description) {
          _push(`<p data-v-d5ff42a6>${ssrInterpolate(etape.description)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (etape.bouton) {
          _push(`<button class="lebtn" data-v-d5ff42a6><span data-v-d5ff42a6>${ssrInterpolate(etape.bouton)}</span></button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-d5ff42a6"]]);
const _sfc_main$4 = {
  __name: "ContactForm",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BZYakU-q.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CWtJPgPI.mjs').then((r) => r.default || r));
